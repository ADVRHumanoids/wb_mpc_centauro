...
void contact_2_absolute_orientation_forward_zero(double const *const * in,
                                                 double*const * out,
   ...
   if( v[38] > v[22] ) {
      v[4] = 1 + v[38] - v[22] - v[32];
   } else {
      v[4] = 1 + v[22] - v[38] - v[32];
   }
   if( v[38] < 0 - v[22] ) {
      v[19] = 1 + v[32] - v[38] - v[22];
   } else {
      v[19] = 1 + v[38] + v[22] + v[32];
   }
   if( v[32] < 0 ) {
      v[19] = v[4];
   } else {
   ...
   v[37] = v[40] * v[36] + v[34] * v[25] + v[37] * v[41];
   v[4] = v[6] + v[37];
   if( v[38] > v[22] ) {
      v[14] = v[19];
   } else {
   ...
   v[33] = 0 - v[22];
   v[34] = v[34] * v[29] + v[40] * v[31];
   v[16] = v[17] * v[43] + v[24] * v[16] + v[11] * v[18];
   v[39] = v[30] * v[42] + v[27] * v[39] + v[16] * v[28];
   v[42] = v[34] + v[39];
   v[16] = v[30] * v[36] + v[27] * v[25] + v[16] * v[41];
   v[15] = v[15] * v[29] + v[21] * v[31];
   v[21] = v[16] - v[15];
   if( v[38] < v[33] ) {
      v[31] = v[42];
   } else {

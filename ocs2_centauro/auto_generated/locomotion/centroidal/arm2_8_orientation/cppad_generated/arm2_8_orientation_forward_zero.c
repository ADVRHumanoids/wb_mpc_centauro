...
void arm2_8_orientation_forward_zero(double const *const * in,
                                     double*const * out,
   ...
   v[26] = -1 * v[31] + -4.89652762780679e-12 * v[2] + -2.06823107111227e-13 * v[11];
   v[23] = -4.8966386501093e-12 * v[30] + v[13] + 2.06823107109202e-13 * v[6];
   v[18] = v[26] - v[23];
   v[32] = -4.8966386501093e-12 * v[36] + v[38] + 2.06823107109202e-13 * v[34];
   v[11] = -2.06823107110214e-13 * v[31] + -2.06823107110214e-13 * v[2] + v[11];
   v[2] = v[32] - v[11];
   if( v[37] > v[7] ) {
      v[31] = v[18];
   } else {
   ...
   v[27] = 0 - v[7];
   v[6] = -2.06823107110214e-13 * v[30] + -2.06823107110214e-13 * v[13] + v[6];
   v[34] = -1 * v[36] + -4.89652762780679e-12 * v[38] + -2.06823107111227e-13 * v[34];
   v[38] = v[6] - v[34];
   if( v[37] > v[7] ) {
      v[36] = 1 + v[37] - v[7] - v[29];
   } else {
      v[36] = 1 + v[7] - v[37] - v[29];
   }
   if( v[37] < 0 - v[7] ) {
      v[13] = 1 + v[29] - v[37] - v[7];
   } else {
      v[13] = 1 + v[37] + v[7] + v[29];
   }
   if( v[29] < 0 ) {
      v[13] = v[36];
   } else {
   ...
   v[13] = v[13] * v[31];
   y[0] = v[36] * x[49] + v[2] * x[51] - x[52] * v[18] - v[13] * x[50];
   y[1] = v[36] * x[50] + v[13] * x[49] - x[52] * v[2] - v[18] * x[51];
   y[2] = v[36] * x[51] + v[18] * x[50] - x[52] * v[13] - v[2] * x[49];
}

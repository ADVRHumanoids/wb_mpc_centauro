...
void dagana_2_tcp_absolute_orientation_forward_zero(double const *const * in,
                                                    double*const * out,
   ...
   if( v[37] > v[4] ) {
      v[28] = 1 + v[37] - v[4] - v[29];
   } else {
      v[28] = 1 + v[4] - v[37] - v[29];
   }
   if( v[37] < 0 - v[4] ) {
      v[16] = 1 + v[29] - v[37] - v[4];
   } else {
      v[16] = 1 + v[37] + v[4] + v[29];
   }
   if( v[29] < 0 ) {
      v[16] = v[28];
   } else {
   ...
   v[13] = -1 * v[31] + 2.06823107110214e-13 * v[6];
   v[38] = v[39] * v[15] + v[38] * v[27];
   v[39] = v[13] + v[38];
   if( v[37] > v[4] ) {
      v[23] = v[16];
   } else {
   ...
   v[6] = -2.06823107110214e-13 * v[31] + -1 * v[6];
   v[31] = v[15] - v[6];
   if( v[37] < v[30] ) {
      v[2] = v[32];
   } else {

...
void arm1_8_absolute_orientation_forward_zero(double const *const * in,
                                              double*const * out,
   ...
   if( v[39] > v[4] ) {
      v[28] = 1 + v[39] - v[4] - v[31];
   } else {
      v[28] = 1 + v[4] - v[39] - v[31];
   }
   if( v[39] < 0 - v[4] ) {
      v[16] = 1 + v[31] - v[39] - v[4];
   } else {
      v[16] = 1 + v[39] + v[4] + v[31];
   }
   if( v[31] < 0 ) {
      v[16] = v[28];
   } else {
   ...
   v[3] = v[13] * v[23] + v[6] * v[35];
   v[37] = v[38] * v[15] + v[37] * v[27];
   v[38] = v[3] + v[37];
   if( v[39] > v[4] ) {
      v[17] = v[16];
   } else {
   ...
   v[35] = v[29] * v[23] + v[11] * v[35];
   v[11] = v[33] + v[35];
   v[15] = v[26] * v[15] + v[2] * v[27];
   v[6] = v[13] * v[30] + v[6] * v[23];
   v[13] = v[15] - v[6];
   if( v[39] < v[24] ) {
      v[23] = v[11];
   } else {

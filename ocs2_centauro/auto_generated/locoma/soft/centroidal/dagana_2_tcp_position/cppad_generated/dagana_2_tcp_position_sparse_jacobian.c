...
void dagana_2_tcp_position_sparse_jacobian(double const *const * in,
                                           double*const * out,
   ...
   v[1] = sin(x[48]);
   v[2] = 0 - v[1];
   v[3] = -0.156 + -0.23 * v[0] + -3.10234660665322e-14 * v[2] - 0.095;
   v[4] = cos(x[46]);
   v[5] = sin(x[47]);
   v[6] = 0 - v[5];
   v[7] = -0.23 * v[1] + -3.10234660665322e-14 * v[0];
   v[8] = cos(x[47]);
   v[9] = -0.015 + -0.049 * v[6] + v[7] * v[8];
   v[10] = sin(x[46]);
   v[11] = 0 - v[10];
   ...
   v[17] = 0.05515 + -0.049 * v[8] + v[7] * v[5] - 0.05515;
   v[18] = cos(x[45]);
   ...
   v[9] = sin(x[47]);
   v[3] = cos(x[47]);
   jac[9] = 0 - (-0.049 * v[37] + v[7] * v[21]) * v[9] + (v[7] * v[37] - -0.049 * v[21]) * v[3];
   v[54] = v[54] * v[10] + v[45] * v[4];
   v[21] = v[21] * v[8] + v[37] * v[5];
   v[37] = sin(x[48]);
   v[45] = cos(x[48]);
   jac[10] = 0 - (-0.23 * v[54] + -3.10234660665322e-14 * v[21]) * v[37] + (-0.23 * v[21] - -3.10234660665322e-14 * v[54]) * v[45];
   v[21] = -0.156 + -0.23 * v[0] + -3.10234660665322e-14 * v[2] - 0.095;
   v[54] = -0.23 * v[1] + -3.10234660665322e-14 * v[0];
   v[7] = -0.015 + -0.049 * v[6] + v[54] * v[8];
   v[35] = -0.074 + v[21] * v[4] + v[7] * v[11] - 0.21815;
   v[12] = 0.05515 + -0.049 * v[8] + v[54] * v[5] - 0.05515;
   ...
   jac[20] = 0 - (-0.049 * v[39] + v[54] * v[57]) * v[9] + (v[54] * v[39] - -0.049 * v[57]) * v[3];
   v[62] = v[62] * v[10] + v[64] * v[4];
   v[57] = v[57] * v[8] + v[39] * v[5];
   jac[21] = 0 - (-0.23 * v[62] + -3.10234660665322e-14 * v[57]) * v[37] + (-0.23 * v[57] - -3.10234660665322e-14 * v[62]) * v[45];
   v[2] = -0.156 + -0.23 * v[0] + -3.10234660665322e-14 * v[2] - 0.095;
   v[1] = -0.23 * v[1] + -3.10234660665322e-14 * v[0];
   v[6] = -0.015 + -0.049 * v[6] + v[1] * v[8];
   v[0] = -0.074 + v[2] * v[4] + v[6] * v[11] - 0.21815;
   v[57] = 0.05515 + -0.049 * v[8] + v[1] * v[5] - 0.05515;
   ...
   jac[30] = 0 - (-0.049 * v[40] + v[1] * v[11]) * v[9] + (v[1] * v[40] - -0.049 * v[11]) * v[3];
   v[20] = v[20] * v[10] + v[25] * v[4];
   v[11] = v[11] * v[8] + v[40] * v[5];
   jac[31] = 0 - (-0.23 * v[20] + -3.10234660665322e-14 * v[11]) * v[37] + (-0.23 * v[11] - -3.10234660665322e-14 * v[20]) * v[45];
